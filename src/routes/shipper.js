...
router.post("/donhang/mark-delivered/:id", isShipper, ShipperController.markDelivered);
...
router.get("/api/pending-orders", isShipper, ShipperController.apiGetPendingOrders);

// API: Lấy đơn hàng đang vận chuyển (JSON)
router.get("/api/active-orders", isShipper, ShipperController.apiGetActiveOrders);

// API: Lấy đơn hàng đã giao (JSON)
router.get("/api/delivered-orders", isShipper, ShipperController.apiGetDeliveredOrders);
...
router.post("/api/mark-delivered/:id", isShipper, ShipperController.apiMarkAsDelivered);

// API: Lấy thông tin chỉ đường (JSON)
router.get("/api/directions/:id", isShipper, ShipperController.apiGetDirections);
