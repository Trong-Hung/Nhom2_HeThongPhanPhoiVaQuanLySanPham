/**
 * TEST REAL-TIME ZONE OPTIMIZATION 🔄
 * Demo hệ thống tối ưu real-time khi có đơn hàng mới
 */
...
// New order 1: Close to existing zone (Q1)
console.log("\n🕐 T+1 giây: Đơn hàng mới tại Q1...");
...
// New order 2: Requires new zone (Tân Bình)
console.log("\n🕑 T+2 giây: Đơn hàng mới tại Tân Bình...");
...
console.log("\n🕒 T+3 giây: Đơn hàng mới tại Thủ Đức...");
...
console.log("📊 3 orders mới đã được tối ưu và phân bổ tự động");
console.log("🗺️ Zones được điều chỉnh theo địa lý thực tế");
console.log("🚛 Shippers được phân công hợp lý theo capacity");
console.log("⚡ Thời gian phản hồi < 10ms cho mỗi order mới");

console.log("\n💡 CÁC TÍNH NĂNG REAL-TIME:");
console.log("   🔄 Tự động phát hiện zone phù hợp cho order mới");
console.log("   📍 Tạo zone mới khi cần thiết");
console.log("   ⚖️  Kiểm tra capacity constraint real-time");
console.log("   🎯 Re-optimize route trong zone khi có thay đổi");
console.log("   📊 Cập nhật load balancing giữa shippers");
